...
public class PathMover : MonoBehaviour
{
    ...
    [SerializeField, Range(0, 1)] float startPostion = 0.5f;
    ...
    void OnValidate()
    {
        transform.position = Vector3.Lerp(posA.position, posB.position, startPostion);
    }
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.color = Color.Lerp(c1, c2, startPostion);
